...
export class firstMigration1663801373913 implements MigrationInterface {
    name = 'firstMigration1663801373913'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "Clients" ("id" uuid NOT NULL, "name" character varying(50) NOT NULL, "email" character varying(50) NOT NULL, "mobileNumber" character varying(11) NOT NULL, "registerDate" TIMESTAMP NOT NULL, CONSTRAINT "UQ_38fd02fc8a88ed82f0c1e6eee4e" UNIQUE ("email"), CONSTRAINT "UQ_1465de5c3770ade0d19e9d87b13" UNIQUE ("mobileNumber"), CONSTRAINT "PK_8dadaa0dc6305d95e1d1a6b9544" PRIMARY KEY ("id"))`);
